...
const getStartText = (ctx) => {
  return `Привет, я перемешиваю буквы в словах. По рзеузльаттам илссоевадний одонго анлигсйокго унвиертисета, это никак не влияет на читаемость текста 😅
...
Автор — @Loskir.
Мой канал — @Loskirs.
Исходники — http://github.com/Loskir/shffl_bot`
}

bot.start((ctx) => {
  let extra = Extra.HTML().webPreview(false)
